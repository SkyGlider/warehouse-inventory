...
public class Lifecycles extends Activity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString("keyNonViewData",nonViewState);
    ...
    protected void onRestoreInstanceState(Bundle inState) {
        ...
        nonViewState = inState.getString("keyNonViewData");
    ...
    private void saveSharedPreferences(){
        SharedPreferences mData = getSharedPreferences("datas",0);
        SharedPreferences.Editor mEditor = mData.edit();
        mEditor.putString("pKey", persistentState);
        mEditor.apply();
    ...
    private void restoreSharedPreferences(){
        SharedPreferences mData = getSharedPreferences("datas",0);
        persistentState = mData.getString("pKey","");
    }
